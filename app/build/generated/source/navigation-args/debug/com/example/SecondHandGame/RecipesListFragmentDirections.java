...
public class RecipesListFragmentDirections {
  ...
  public static ActionRecipesListFragmentToRecipeFragment actionRecipesListFragmentToRecipeFragment(
    ...
    return new ActionRecipesListFragmentToRecipeFragment(NameRecipe, Ingredients, Instructions, avatarUrl);
  }
  ...
  public static class ActionRecipesListFragmentToRecipeFragment implements NavDirections {
    ...
    private ActionRecipesListFragmentToRecipeFragment(@NonNull String NameRecipe,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionRecipesListFragmentToRecipeFragment setNameRecipe(@NonNull String NameRecipe) {
      if (NameRecipe == null) {
        throw new IllegalArgumentException("Argument \"NameRecipe\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("NameRecipe", NameRecipe);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionRecipesListFragmentToRecipeFragment setIngredients(@NonNull String Ingredients) {
      if (Ingredients == null) {
        throw new IllegalArgumentException("Argument \"Ingredients\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("Ingredients", Ingredients);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionRecipesListFragmentToRecipeFragment setInstructions(@NonNull String Instructions) {
      if (Instructions == null) {
        throw new IllegalArgumentException("Argument \"Instructions\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("Instructions", Instructions);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionRecipesListFragmentToRecipeFragment setAvatarUrl(@Nullable String avatarUrl) {
      this.arguments.put("avatarUrl", avatarUrl);
      return this;
    }
