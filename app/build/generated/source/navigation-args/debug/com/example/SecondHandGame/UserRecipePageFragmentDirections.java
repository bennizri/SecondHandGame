...
public class UserRecipePageFragmentDirections {
  private UserRecipePageFragmentDirections() {
  }

  @NonNull
  public static ActionFragmentUserRecipePageToEditUserRecipePageFragment2 actionFragmentUserRecipePageToEditUserRecipePageFragment2(
      @NonNull String NameRecipe, @NonNull String Ingredients, @NonNull String Instructions,
      @Nullable String avatarUrl) {
    return new ActionFragmentUserRecipePageToEditUserRecipePageFragment2(NameRecipe, Ingredients, Instructions, avatarUrl);
  }
  ...
  public static class ActionFragmentUserRecipePageToEditUserRecipePageFragment2 implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionFragmentUserRecipePageToEditUserRecipePageFragment2(@NonNull String NameRecipe,
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFragmentUserRecipePageToEditUserRecipePageFragment2 setNameRecipe(
        @NonNull String NameRecipe) {
      if (NameRecipe == null) {
        throw new IllegalArgumentException("Argument \"NameRecipe\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("NameRecipe", NameRecipe);
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFragmentUserRecipePageToEditUserRecipePageFragment2 setIngredients(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFragmentUserRecipePageToEditUserRecipePageFragment2 setInstructions(
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionFragmentUserRecipePageToEditUserRecipePageFragment2 setAvatarUrl(
        @Nullable String avatarUrl) {
      this.arguments.put("avatarUrl", avatarUrl);
      return this;
    }
    ...
    public int getActionId() {
      return R.id.action_fragment_user_recipe_page_to_editUserRecipePageFragment2;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionFragmentUserRecipePageToEditUserRecipePageFragment2 that = (ActionFragmentUserRecipePageToEditUserRecipePageFragment2) object;
    ...
    public String toString() {
      return "ActionFragmentUserRecipePageToEditUserRecipePageFragment2(actionId=" + getActionId() + "){"
