...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView mainBottomNavigationView,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.main_navhost;
      FragmentContainerView mainNavhost = ViewBindings.findChildViewById(rootView, id);
      if (mainNavhost == null) {
        break missingId;
      }

      return new ActivityMainBinding((ConstraintLayout) rootView, mainBottomNavigationView,
          mainNavhost);
    }
